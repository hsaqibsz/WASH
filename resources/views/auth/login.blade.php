    ...
    <body>
        ...
        <div id="page-wrapper" class="page-loading">
            ...
            <div class="preloader themed-background">
                <h1 class="push-top-bottom text-light text-center"><strong>ORD</strong>WASH</h1>
                <div class="inner">
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                <h1><i class="gi gi-flash"></i> <strong>ORD-WASH</strong><br><small>Please <strong>Login</strong> or <strong>Register</strong></small></h1>
            </div>
            <!-- END Login Title -->
            @if($errors->any())
            ...
            <div class="block push-bit">
                ...
                <!-- Register Form -->
                <form  method="POST" action="{{ route('user.register') }}" id="form-register" class="form-horizontal form-bordered form-control-borderless display-none">
                    @csrf
                    <div class="form-group">
                        <div class="col-xs-6">
                            <div class="input-group">
