...
<?php $step1=0; ?>
 <div class="block">
                                     ...
                                     <!-- END Basic Wizard Title -->
                                         ...
                                         <!-- Second Step -->
                                             <form id="basic-wizard" action="{{route('user.complete_profile4', $profile->id)}}" method="post" class="form-horizontal form-bordered ui-formwizard" enctype="multipart/form-data">
                                      @csrf
