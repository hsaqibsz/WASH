...
@section('page-content')
 ...
 <div class="block">
                 ...
                 <!-- END Basic Wizard Title -->
                     ...
                     <!-- Second Step -->
                         <form id="basic-wizard" action="{{route('user.complete_profile5', $profile->id)}}" method="post" class="form-horizontal form-bordered ui-formwizard" enctype="multipart/form-data">
                  @csrf
