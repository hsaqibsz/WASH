...
@section('page-content')
 ...
 <div class="block">
                 ...
                 <!-- END Basic Wizard Title -->
                     ...
                     <!-- Second Step -->
                         <form id="basic-wizard" action="{{route('user.complete_profile6', $profile->id)}}" method="post" class="form-horizontal form-bordered ui-formwizard" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group">
                       ...
                       <div class="form-group">
                                ...
                                <div class="col-md-6">
                        <input type="radio" name="completed" value="1" @if($porifile->completed == 1) selected @endif> Yes &nbsp; <input type="radio" name="completed" value="0" @if($profile->completed == 0) selected @endif > No <br>
                        </div>
                      </div>
