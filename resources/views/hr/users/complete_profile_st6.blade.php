...
@section('page-content')
 ...
 <div class="block">
                 ...
                 <!-- END Basic Wizard Title -->
                     ...
                     <!-- Second Step -->
                         <form id="basic-wizard" action="{{route('user.complete_profile7', $profile->id)}}" method="post" class="form-horizontal form-bordered ui-formwizard" enctype="multipart/form-data">
                  @csrf
                                    ...
                                    <textarea class="form-control" name="responsibilities" placeholder="Responsibilities"></textarea>
                                             ...
                                             <div class="form-group form-actions">
                                                 ...
                                                 <div class="col-md-8 col-md-offset-4">
                                                     ...
                                                     <a href="{{route('user.complete_profile8', $profile->user_id)}}" class="btn btn-sm btn-primary ui-wizard-content ui-formwizard-button"> Submit & Ask for Verification </a>
                                                 </div>
                                             </div>
                                             <!-- END Form Buttons -->
