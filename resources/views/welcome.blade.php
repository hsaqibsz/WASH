                        ...
                        <ul class="timeline-list">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="row push">
                                        <div class="col-sm-6 col-md-4">
                                            <a href="{{asset('assets/admin/img/placeholders/photos/photo1.jpg') }}" data-toggle="lightbox-image">
                                                <img src="{{asset('assets/admin/img/placeholders/photos/photo1.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <a href="{{asset('assets/admin/img/placeholders/photos/photo22.jpg') }}" data-toggle="lightbox-image">
                                                <img src="{{asset('assets/admin/img/placeholders/photos/photo22.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="active">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="row push">
                                        <div class="col-sm-6 col-md-4">
                                            <a href="{{asset('assets/admin/img/placeholders/photos/photo23.jpg') }}" data-toggle="lightbox-image">
                                                <img src="{{asset('assets/admin/img/placeholders/photos/photo23.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="widget">
                <div class="widget-advanced widget-advanced-alt">
                    ...
                    <div class="widget-header text-left">
                        ...
                        <img src="{{asset('assets/admin/img/placeholders/headers/widget5_header.jpg') }}" alt="background" class="widget-background animation-pulseSlow">
                    ...
                    <div class="widget-main">
                        ...
                        <div class="gallery gallery-widget" data-toggle="lightbox-gallery">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <a href="{{asset('assets/admin/img/placeholders/photos/photo13.jpg') }}" class="gallery-link" title="Image Info">
                                        <img src="{{asset('assets/admin/img/placeholders/photos/photo13.jpg') }}" alt="image">
                                    </a>
                                </div>
                            </div>
                        </div>
